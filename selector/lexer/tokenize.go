...
func (p *Tokenizer) parseCurRune() (Token, error) {
	...
	default:
		...
		if t := matchStr(pos, "reduce", false, Reduce); t != nil {
			return *t, nil
		}
		if t := matchStr(pos, "mapValues", false, MapValues); t != nil {
			return *t, nil
		}
		if t := matchStr(pos, "any", false, Any); t != nil {
			return *t, nil
		}
		if t := matchStr(pos, "all", false, All); t != nil {
			return *t, nil
		}
		if t := matchStr(pos, "count", false, Count); t != nil {
			return *t, nil
		}
